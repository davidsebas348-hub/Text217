...
local function duplicateTool(num)
    ...
    local original = backpack:FindFirstChild(breakName)
...
screenGui.Name = "BreakDuplicatorGUI"
...
textBox.PlaceholderText = "Cantidad de Breaks"
textBox.Text = "1"
